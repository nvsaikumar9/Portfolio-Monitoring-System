...
df = pd.read_excel(r'C:\Vizual Studio Code\Python Programs\Project-PriceAlert\Portfolio_details.xlsx')
...
for stock_name in stock_names:
    if stock_name in price_data:
        ...
        if not stock_data.empty:    
            ...
            LTP['REF_SYMBOL'].append(df[df['STOCK_NAME'] == stock_name].iloc[0]['REF_SYMBOL'])
